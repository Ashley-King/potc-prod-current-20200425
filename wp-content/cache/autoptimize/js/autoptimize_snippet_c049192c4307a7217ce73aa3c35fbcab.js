jQuery(document).ready(function($){function isValidRecaptcha(){$recap=$('#1xq8nm input[name="recaptha_response"]').val();if($recap.length&&!$recap==''&&!$recap==undefined){return true;}
return false;}
