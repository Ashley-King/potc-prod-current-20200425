...
html div#$optin_uuid div#$optin_css_id.gridgum_container .gridgum_body-form .gridgum_input_field.radio-field,
html div#$optin_uuid div#$optin_css_id.gridgum_container .gridgum_body-form .gridgum_input_field.checkbox-field{
    padding-left: 6px;
    padding-right: 6px;
}

html div#$optin_uuid div#$optin_css_id.gridgum_container .gridgum_body-form .gridgum_input_field.radio-field label,
html div#$optin_uuid div#$optin_css_id.gridgum_container .gridgum_body-form .gridgum_input_field.checkbox-field label{
    margin-top: 6px;
}

html div#$optin_uuid div#$optin_css_id.gridgum_container .gridgum_body-form .gridgum_input_field.radio-field label input,
html div#$optin_uuid div#$optin_css_id.gridgum_container .gridgum_body-form .gridgum_input_field.checkbox-field label input{
    margin-right: 6px;
}
CSS;
