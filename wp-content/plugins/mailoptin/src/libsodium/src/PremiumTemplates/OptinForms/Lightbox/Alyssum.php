...
html div#$optin_uuid div#$optin_css_id.alyssum .alyssum-intro-section span,
html div#$optin_uuid div#$optin_css_id.alyssum .alyssum-intro-section h3 {
	display: block;
}
...
html div#$optin_uuid div#$optin_css_id.alyssum .intro-arrow {
	position: absolute;
	left: 6px;
	top: -11px;
}
...
html div#$optin_uuid div#$optin_css_id.alyssum .intro-arrow img {
	width: 100px;
}
...
@media only screen and (min-width: 980px){
    ...
    html div#$optin_uuid.mo-optin-has-custom-field div#$optin_css_id .alyssum_subscibe_btn,
    div#$optin_css_id.mo-has-name-email .alyssum_subscibe_btn {
        width: 350px;
    }
