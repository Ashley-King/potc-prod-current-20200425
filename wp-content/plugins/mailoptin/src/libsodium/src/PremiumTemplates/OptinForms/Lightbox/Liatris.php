...
html div#$optin_uuid div#$optin_css_id .liatris_middle-section .liatris_description {
	text-align: center;
	padding: 30px 0 20px;
}
...
html div#$optin_uuid div#$optin_css_id .liatris_attendant_image + .liatris_top-section_inner {
	margin-top: 40px;
}
...
@media only screen and (min-width: 580px) {
	...
	html div#$optin_uuid div#$optin_css_id .liatris_inner {
		padding: 0 20px;
	}
}
...
@media only screen and (min-width: 750px) {
    ...
    html div#$optin_uuid.mo-optin-has-custom-field div#$optin_css_id .liatris_field,
    html div#$optin_uuid div#$optin_css_id.mo-has-name-email .liatris_field {
        width: 100%;
    }
    html div#$optin_uuid div#$optin_css_id .liatris_fields_wrap {
        display: flex;
    ...
    html div#$optin_uuid.mo-optin-has-custom-field div#$optin_css_id .liatris_fields_wrap,
    html div#$optin_uuid div#$optin_css_id.mo-has-name-email .liatris_fields_wrap {
        display: block;
        padding: 0;
    }
	html div#$optin_uuid div#$optin_css_id .liatris_attendant_image.liatris-img-is-responsive {
    ...
    html div#$optin_uuid.mo-optin-has-custom-field div#$optin_css_id .liatris_sub_field,
    html div#$optin_uuid div#$optin_css_id.mo-has-name-email .liatris_sub_field {
        width: 100%;
    }
	html div#$optin_uuid div#$optin_css_id .liatris_fields.liatris_sub_field {
		margin-top: 20px;
	}
    html div#$optin_uuid.mo-optin-has-custom-field div#$optin_css_id .liatris_fields.liatris_sub_field,
    html div#$optin_uuid div#$optin_css_id.mo-has-name-email .liatris_fields.liatris_sub_field {
        margin-top: 20px;
    }
	html div#$optin_uuid div#$optin_css_id .liatris_note {
		font-size: 14px;
